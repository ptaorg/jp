...
PTA会費は、任意団体であるPTAに加入した会員が、その団体運営のために負担する会費です。教材費、校外活動費、給食費等のような学校教育活動又は学校生活に必要な学校徴収金とは、性質が異なります。したがって、PTA会費を学校徴収金と同じ通知、同じ口座、同じ口座振替、同じ未納管理で扱うことは、保護者に「学校に支払うべき費用」との誤認を生じさせます。

文部科学省の学校・教師が担う業務に係る3分類資料は、学校徴収金の徴収・管理について、教職員が関与しない方法や地方公共団体・教育委員会による徴収・管理を進める状況を示しています。学校徴収金ですら業務適正化の対象であるなら、学校徴収金ではないPTA会費を学校が徴収・管理することは、より厳格に点検されなければなりません。

入会申込記録が確認できない保護者からPTA会費を徴収することは、会員根拠の確認できない者に会費を請求することになります。学校がその徴収に関与すれば、学校が根拠不明の私的会費徴収を支えていることになります。学校とPTAとの間に会費徴収委任、覚書、協定等があったとしても、それは学校とPTAの間の事務処理の根拠にとどまり、保護者本人のPTA入会意思、会費支払義務、口座引落し同意を代替するものではありません。

特に問題となるのは、学校納入金通知にPTA会費を混在させること、学校管理口座又は学校徴収金口座でPTA会費を処理すること、学校徴収金と同一の口座振替でPTA会費を引き落とすこと、学校職員が未納一覧、会費一覧、督促文、会計資料を作成することです。これらはいずれも、PTA会費を学校費用の一部であるかのように見せる効果を持ちます。
...
根拠資料ID: L019、L001、L002、L010、L015、L017、M002
...
学校管理職がPTAと関わる場合であっても、その役割は学校との連絡調整、施設利用条件の確認、学校教育活動との調整に限定されるべきです。PTAの入会管理、会費徴収、会員名簿作成、役員選出、免除審査、会計、監査に関与する役員兼任は見直す必要があります。
...
学校連絡ツールは、学校教育上の連絡のために登録された連絡先を利用するものです。これをPTA加入案内、役員希望調査、免除申請、会費徴収、会費督促、応援金・支援金依頼、非会員向け連絡に使うなら、学校の連絡基盤をPTA目的で利用していることになります。PTAに名簿を渡していないとしても、学校が保有する連絡先情報をPTA目的で内部利用している問題は残ります。

PTAが作成した文面を学校が送信する形式であっても、実質的にはPTAの本来事務を学校の情報基盤で処理していることに変わりません。学校連絡ツールを使う場合には、少なくとも学校アカウントとPTAアカウントを分離し、PTA内部事務はPTAの責任で、加入者又は明確に同意した者に対して行う必要があります。
...
PTA説明を行う場合でも、学校説明とは時間、資料、説明者、提出先、問い合わせ先を分ける必要があります。学校説明会終了後の任意参加のPTA説明とし、不参加でも不利益がないこと、PTA加入は任意であること、非加入でも児童生徒に不利益がないことを明記すべきです。
...
PTA資料はPTA名義で作成し、提出先、問い合わせ先、回収方法もPTA側で完結させる必要があります。学校名、校長名、担任名、学校連絡ツールの学校アカウントを用いてPTA内部事務を処理すれば、学校が任意団体の加入、会費、役員、免除、名簿、連絡を支えていることになります。

教育委員会は、次の分離基準を示すべきです。

- 入学式本体でPTA加入手続を行わない。
- 学校説明資料とPTA資料を明確に分ける。
- PTA説明は、学校説明と時間、資料、説明者、提出先、問い合わせ先を分ける。
- PTA説明を行う場合は、任意参加、不参加不利益なし、任意加入、非加入児童生徒への不利益なしを明記する。
- PTA加入申込書はPTA名義で作成し、提出先と問い合わせ先もPTAにする。
- PTA役員希望調査は、加入確認後の会員だけに行う。
- 学校連絡ツールでPTA内部事務を行わない。
- PTA文面を学校アカウントで送信しない。
- 学校連絡ツールを使う場合でも、学校アカウントとPTAアカウントを分離する。
- 児童を通じた会費回収、免除書類回収、督促を行わない。
- 担任がPTA加入申込書、会費袋、役員希望調査、免除申請書、督促文を回収しない。
- 免除申請で障害、疾病、ひとり親、介護、就労状況等に関する資料を学校又は担任に提出させない。
...
根拠資料ID: L003、L008、L009、L014、L015、L017、L018、M001、M002、P001
...
第一章及び第四章で述べたとおり、判定の中心は、全会員分の入会申込記録が存在するか、未提出者をどう扱っているか、会費徴収・名簿・連絡がどの経路で処理されているかです。周知文書の有無を確認して終える調査は、混在運用をかえって固定化させます。
...
第三章で述べたとおり、学校長とPTA会長の間の委任契約、覚書、協定は、学校とPTAの間の事務処理の根拠にとどまります。保護者本人の入会意思、会費支払義務、名簿提供同意を代替するものではありません。
...
第三章及び第五章で述べたとおり、入会同意、名簿提供同意、会費徴収同意、役員選出対象となることへの同意は、性質の異なる意思表示です。入学手続の流れの中で一括して取得した同意は、保護者が何に同意したのかを区別できず、自由な意思に基づく同意であったかどうかも慎重に確認されなければなりません。
...
根拠資料ID: L001、L004、L005、L020、L008、L015、L017
...
ここまでの本文は、PTAと学校の混在運用を、学校運営上どのように分離すべきかを説明するためのものです。本章に掲げる資料は、本文の代替ではなく、教育委員会内部での検討、校長会での共有、各学校への実態確認に使うための実務資料です。
...
本章では、本文で用いた法令、通知、行政資料、自治体回答の確認方法を整理します。この文書では、本文の主張と根拠資料を対応させるため、確認済み一次資料を `sources/primary-sources.csv` で管理します。
