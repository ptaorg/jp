...
- national.html：全国PTA資料。学校別・自治体別の実物資料を論点別に整理するページ。
- articles.html：論考。資料と回答をもとに制度的な説明を行うページ。
- responses.html：教育委員会回答集の掲載形式。
- support.html：応援・寄付。公文書開示、教育委員会訪問、資料整理、Web公開の支援ページ。
- contact.html：連絡窓口。
...
4. index.html、parents.html、pta.html、board.html、materials.html、national.html、articles.html、responses.html、support.html、contact.html を確認する。
